...
client.on('message', async message => {
  ...
  if (pg[message.guild.id].mode === 1) {
    ...
    let swearwords = ["fuck", "nignog", "nig-nog", "nigger", "nig-nog", "ass", "bastard", "bitch", "slut", "pussy", "vagina", "dick", "penis", "bollocks", "crap", "cunt", "frigger", "shit", "niga", "niqqer", "nigqer", "niqger", "negro", "niglet", "whore", "twat", "gypsy", "fag", "faggot"]
...
if (censor[message.guild.id].toggle === 1) {
  ...
  let slurs = ["slut", "nignog", "nig-nog", "nigger", "niqqer", "nigqer", "niqger", "negro", "niglet", "whore", "gypsy", "fag", "faggot"]
